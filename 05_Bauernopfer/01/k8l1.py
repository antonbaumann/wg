        ...
        for i, pawn in enumerate(pawns):
            ...
            for target_square in moves:
                ...
                if nr_moves_rook in best_moves:
                    best_moves[nr_moves_rook].append((i, target_square, nr_moves_rook))
                else:
                    best_moves[nr_moves_rook] = [(i, target_square, nr_moves_rook)]
        ...
        for k, v in best_moves.items():
            for m in v:
                ...
                if B_copy.check_chain():
                    print("Best move:", coord_to_str(self.B.pawns[m[0]].pos), '-', coord_to_str(m[1]), ':', m[2])
